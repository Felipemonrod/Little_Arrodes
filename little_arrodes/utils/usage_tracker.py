...
class UsageTracker:
    ...
    def __init__(
        ...
        """
        Args:
            daily_request_limit: Máximo de requests por dia (free tier = 1500 RPD).
            minute_request_limit: Máximo de requests por minuto (estimativa local para teste).
            hour_request_limit: Máximo de requests por hora (estimativa local para teste).
            daily_token_limit: Máximo de tokens por dia (estimativa conservadora).
            threshold: Porcentagem de uso que ativa o modo offline (0.80 = 80% usado = 20% restante).
        """
