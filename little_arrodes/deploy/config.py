...
Carrega variáveis de ambiente (Docker env_file ou .env local).
"""
...
def validate_config() -> list[str]:
    ...
    if not DISCORD_TOKEN:
        errors.append("DISCORD_TOKEN não definido nas variáveis de ambiente")
    if not GEMINI_API_KEY:
        errors.append("GEMINI_API_KEY não definido nas variáveis de ambiente")
    return errors
