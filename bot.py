...
if errors:
    ...
    log.critical("Corrija o arquivo .env e tente novamente. Use .env.example como referência.")
    sys.exit(1)
...
async def on_ready() -> None:
    """Executado quando o bot conecta ao Discord."""
    log.info("=" * 50)
...
async def main() -> None:
    ...
    async with bot:
        # Carrega todos os cogs iniciais
